...
export default {
  ...
  columnChart: {
    series: [
      {
        name: 'Maintenance',
        data: [90, 120, 55, 100, 80, 125, 175, 70, 88, 180,55, 100],
      },
      {
        name: 'No Operator',
        data: [85, 100, 30, 40, 95, 90, 30, 110, 62, 20,30, 110],
      },
      {
        name: 'Material',
        data: [85, 100, 30, 40, 95, 90, 30, 110, 62, 20,100, 30],
      },
    ],
    chartOptions: {
      chart: {
      ...
      colors: [chartColors.pareto.lv3, chartColors.pareto.lv2, chartColors.pareto.lv1],
      plotOptions: {
        bar: {
          horizontal: false,
          borderRadius: 13,
