                    ...
                    <v-card-text>->
                      <v-row :id="'mysl'+i">
                        <v-col  cols="12" md="6" sm="6" xs="12"  class="d-flex align-center">
                          <div class="d-flex" style="width: 100%; background: rgb(118, 210, 80, 0.6); border-radius: 75px;  align-items: center; padding: 15px; " >
                        ...
                        <v-col  cols="12" md="3" sm="6" xs="12"  class="d-flex align-center">
                          <div style=" width: 100%; height: 100%;  position: relative;">
                            ...
                            <h1 style="position: absolute; bottom: 0; color: #3F8FA8; right: 20px; font-size: 25px;" ><img width="27" src="@/assets/images/dashboard/water-outline.png" alt=""> 83%</h1>
                          </div>
                        ...
                        <div class="container_grid">
                          ...
                          <div class="vibration card-div">
                            ...
                            <div class="tabs-custom">
                              ...
                              <label for="tab2"><img width="27" src="@/assets/images/dashboard/i3.png" alt=""> Location 2</label>

                              <section id="content1">
                                <vue-apex-charts style="width: 100%; height: 100%;"  type="line" :options="options" :series="series"></vue-apex-charts>
                              </section>
