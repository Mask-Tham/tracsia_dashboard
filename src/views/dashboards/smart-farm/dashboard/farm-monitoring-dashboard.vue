                  ...
                  <v-row :id="'mysl'+i">
                    ...
                    <div class="container_grid">
                      ...
                      <div class="temp card-div">
                        <v-row style="height: 100%;">
                          <v-col class="p-0" cols="4" md="4" sm="6" xs="12">
                            <img  width="150" :src="require(`@/assets/images/dashboard/tempicon.png`)" alt="">
                          </v-col>
                      ...
                      <div class="vibration card-div">
                        <v-row style="height: 100%;">
                          <v-col class="p-0" cols="4" md="5" sm="6" xs="12">
                            <div >Vibration Detection</div>
                            <img  width="150" :src="require(`@/assets/images/dashboard/tempicon.png`)" alt="">
                          </v-col>
