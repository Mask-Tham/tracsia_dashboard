                  ...
                  <div class="container_grid">
                    ...
                    <div class="vibration card-div">
                      <v-row style="height: 100%; align-items: center;">
                        ...
                        <v-col class="p-0 " sttle="display: flex; height: 100%; justify-content: center; flex-direction: column; align-items: center;" cols="4" md="3" sm="6" xs="12">
                          <div style="height: calc(100% / 3)" class="mb-1" align="center" v-for="(i, item) in vibration" :key="item">
                            <h4 class="cont-btn">{{ i.text }}-Axis</h4>
                            <h6>Speed : {{ i.value }} mm/s</h6>
                            <h6>Frequency : {{ i.value }} Hz</h6>
                          </div>
                        </v-col>
                      </v-row>
                    </div>
...
export default {
  ...
  data() {
    return {
      ...
      vibration: [
        { text: 'X', value: '0.89' }, { text: 'Y', value: '0.10' }, { text: 'Z', value: '0.23' },],
      hearderTable: [
