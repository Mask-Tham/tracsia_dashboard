<template>
  <v-card>
    <v-card-title> Custom Timeline Card </v-card-title>

    <v-card-text>
      <v-timeline dense class="timeline-custom-dense timeline-custom-dots card-content">
        <!-- Flight -->
        <v-timeline-item small color="error">
          <v-card color="error">
            <v-card-title>
              <span class="text-base white--text">Get on the flight</span>
              <v-spacer></v-spacer>
              <small class="text-xs white--text">Wednesday</small>
            </v-card-title>
        ...
        <v-timeline-item small color="primary">
          <v-card color="primary">
            <v-card-title>
              <span class="text-base white--text">Interview Schedule</span>
              <v-spacer></v-spacer>
              <small class="text-xs white--text text-no-wrap">April, 18</small>
            </v-card-title>
            <v-card-text class="pt-4">
              <p class="mb-0">
        ...
        <v-timeline-item small color="info">
          <v-card color="info">
            <v-card-title>
              <span class="text-base white--text">Sold Puma POPX Blue Color</span>
              <v-spacer></v-spacer>
        ...
        <v-timeline-item small color="success">
          <v-card color="success">
            <v-card-title>
              <span class="text-base white--text">Design Review</span>
              <v-spacer></v-spacer>
              <small class="text-xs white--text text-no-wrap">September, 20</small>
            </v-card-title>
            <v-card-text class="pt-4">
