    ...
    <v-col cols="12">
      <v-card class="pt-10">
        <v-card-title class="justify-center flex-column">
          <v-avatar
            :color="userData.picture ? '' : 'primary'"
            :class="userData.picture ? '' : 'v-avatar-light-bg primary--text'"
            size="120"
            rounded
            class="mb-4"
          >
            <v-img
              ...
              :src="require(`@/assets/images/avatars/${userData.picture}`)"
            ></v-img>
            <span
              v-else
          ...
          <v-chip
            label
            small
            :color="resolveUserRoleVariant(userData.roleID)"
        ...
        <v-card-text>
          ...
          <v-list>
            ...
            >
              ...
              <span class="text--secondary text-capitalize">{{ userData.roleID }}</span>
            </v-list-item>
            <v-list-item
              dense
              class="px-0 mb-n2"
            >
              <span class="font-weight-medium me-2">Customer ID:</span>
              <span class="text--secondary">{{ userData.custumerID }}</span>
            </v-list-item>
            ...
            >
              ...
              <span class="text--secondary">{{ userData.gender }}</span>
            </v-list-item>
            ...
            >
              ...
              <span class="text--secondary">{{ userData.position }}</span>
            </v-list-item>
            ...
            >
              ...
              <span class="text--secondary">{{ userData.phone_number }}</span>
            </v-list-item>
            ...
            >
              ...
              <span class="text--secondary">{{ userData.birthdate }}</span>
            </v-list-item>
          </v-list>
        </v-card-text>
